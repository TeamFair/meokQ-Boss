...
abstract class MeokqApi {
  ...
  @POST('/api/open/login')
  Future<ResponseVO> login({ // login api
  ...
  Future<ResponseVO> postAgreement({ // 약관동의 내역 저장
     @Body() required String body,
  });

  @POST('/api/boss/market')
  Future<ResponseVO> postMarket({ // 마켓정보 등록
     @Body() required Map<String, dynamic> body,
  });

  @POST('/api/boss/market/auth')
  Future<ResponseVO> postAuth({ // 마켓인증내역 등록
     @Body() required  Map<String, dynamic> body,
  });
