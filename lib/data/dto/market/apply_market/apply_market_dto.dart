...
part 'apply_market_dto.freezed.dart';
part 'apply_market_dto.g.dart';

@freezed
class ApplyMarketDTO with _$ApplyMarketDTO {
  const factory ApplyMarketDTO({
    ...
    @JsonKey(name: 'marketTime') required List<MarketTime> marketTime,
  }) = _ApplyMarketDTO;

  factory ApplyMarketDTO.fromJson(Map<String, dynamic> json) =>
      _$ApplyMarketDTOFromJson(json);
}
